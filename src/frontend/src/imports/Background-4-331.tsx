...
function Component() {
  return (
    <div
      className="box-border content-stretch flex h-[44px] items-center justify-center min-w-[80px] px-[16px] py-0 relative shrink-0"
...
function Container1() {
  return (
    ...
    >
      <div
        className="absolute bg-[#9e8cfc] bottom-[-4px] h-[2px] left-[-5px] w-[54.09px]"
...
function Component2() {
  return (
    <div
      className="bg-[#443592] box-border content-stretch flex h-[44px] items-center justify-center min-w-[80px] pl-[17.96px] pr-[17.95px] py-0 relative shrink-0"
...
function Component1() {
  return (
    <div
      className="box-border content-stretch flex h-[44px] items-center justify-center min-w-[80px] pl-[17.85px] pr-[17.84px] py-0 relative shrink-0"
      data-name="Component 3"
    >
      <Container2 />
    </div>
...
function Nav() {
  return (
    <div
      className="content-stretch flex items-start relative shrink-0 w-[1153px]"
      data-name="Nav"
    >
      <Container4 />
    </div>
...
export default function Background() {
  return (
    <div
      className="bg-[#392c72] content-stretch flex flex-col items-center relative size-full"
